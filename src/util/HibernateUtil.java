...
public class HibernateUtil {
	...
	private static SessionFactory buildSessionJavaConfigFactory() {
		try {
			...
			props.put("hibernate.connection.url", "jdbc:mysql://localhost/contabilidad");
			...
			configuration.addAnnotatedClass(CuentaBancaria.class);
			configuration.addAnnotatedClass(Operacion.class);
